<!doctype html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/chosen.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/bundle.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/ionicons.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/prettyPhoto.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/price-range.css')); ?>" >
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/animate.css')); ?>" >
          ...
          <div class="col-12">
            <div class="header_wrapper_inner">
              <div class="logo col-xs-12">
                <a href="index.html"><img src="<?php echo e(asset('public/frontend/images/logo/eva.jpg')); ?>" alt=""></a>
              </div>
              <div class="header_right_info d-flex">
                <div class="mini__cart">
                  <div class="cart_icon">
                    <a href="<?php echo e(URL::to('/login-checkout')); ?>"><i class="fa fa-user"> Tài khoản</i></a>
                  </div>
                </div>
                <div class="content-setting-dropdown"></div>
                  <div class="mini__cart">
                    <div class="cart_icon">
                      <a href="<?php echo e(URL::to('/show-cart')); ?>"><i class="fa fa-shopping-cart"> Giỏ hàng</i></a>
                    </div>
                  </div>
                  <?php
                  ...
                  <div class="mini__cart">
                  <div class="cart_icon">
                    <a href="<?php echo e(URL::to('/logout-checkout')); ?>"><i class="fa fa-lock"> Đăng xuất</i></a>
                  </div>
                </div>
                <?php
              }else{
              ...
              <div class="mini__cart">
                  <div class="cart_icon">
                    <a href="<?php echo e(URL::to('/logout-checkout')); ?>"><i class="fa fa-lock"> Đăng nhập</i></a>
                  </div>
                </div>
              <?php
            }
 ...
 <!--breadcrumb area start-->
    ...
    <div class="container-fluid">
          ...
          <div class="header_wrapper_inner">
            ...
            <div class="main_menu_inner">
              <div class="menu">
                <nav>
                  <ul>
                    <li class="active"><a href="<?php echo e(URL::to('/trang-chu')); ?>">Trang chủ <i class="fa fa-angle-down"></i></a></li>
                    <li><a href="<?php echo e(URL::to('/bo-suu-tap')); ?>">Bộ sưu tập</a></li>
                    <li><a href="<?php echo e(URL::to('/gioi-thieu')); ?>">Giới thiệu </a> </li>
     ...
     <!--Brand logo start-->  
                              ...
                              <div class="col-12">
                                  <div class="brand_list_carousel owl-carousel">
                                      <div class="single_brand_logo">
                                          <a href="#">
                                              <img src="<?php echo e(asset('public/frontend/images/brand/1.jpg')); ?>" alt="brand logo">
                                          </a>
                                      </div>
                                      <div class="single_brand_logo">
                                          <a href="#">
                                              <img src="<?php echo e(asset('public/frontend/images/brand/2.jpg')); ?>" alt="brand logo">
                                          </a>
                                      </div>
                                      <div class="single_brand_logo">
                                          <a href="#">
                                              <img src="<?php echo e(asset('public/frontend/images/brand/3.jpg')); ?>" alt="brand logo">
                                          </a>
                                      </div>
                                      <div class="single_brand_logo">
                                          <a href="#">
                                              <img src="<?php echo e(asset('public/frontend/images/brand/4.jpg')); ?>" alt="brand logo">
                                          </a>
                                      </div>
                                      <div class="single_brand_logo">
                                          <a href="#">
                                              <img src="<?php echo e(asset('public/frontend/images/brand/5.jpg')); ?>" alt="brand logo">
                                          </a>
                                      </div>
                                      <div class="single_brand_logo">
                                          <a href="#">
                          ...
                          <div class="row">
                                  ...
                                  <div class="single_footer widget">
                                      <div class="single_footer_widget_inner">
                                          <div class="footer_logo">
                                              <a href="#"><img src="<?php echo e(asset('public/frontend/images/logo/eva.jpg')); ?>" alt=""></a>
                                          </div>
                              ...
                              <div class="col-lg-3 col-md-12 col-xs-12">
                                  ...
                                  <div class="footer_news_letter">
                                      <p>DV Cosmetic trang mua sắm trực tuyến của các thương hiệu son môi, giúp bạn tiếp cận xu hướng làm đẹp mới nhất..</p>
                                  </div>
                              </div>
                          </div>
                      </div>
            ...
            <!-- all js here -->
          <script src="<?php echo e(asset('public/frontend/js/vendor/jquery-1.12.0.min.js')); ?>"></script>
          ...
          <script src="<?php echo e(asset('public/frontend/js/jquery-ui.js')); ?>"></script>
          ...
          <script src="<?php echo e(asset('public/frontend/js/map.js')); ?>"></script>
          <script src="http://itexpress.vn/API/files/it.snow.js"></script>
      </body>
  </html>
<?php /**PATH C:\xampp\htdocs\DACS2\resources\views/welcome.blade.php ENDPATH**/ ?>