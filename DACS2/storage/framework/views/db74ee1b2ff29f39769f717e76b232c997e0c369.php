                          ...
                          <div class="row">
                              <div class="col-lg-4 col-md-6">
                                  <div class="single_banner">
                                      <a href="#">
                                          <img src="<?php echo e(('public/frontend/images/banner/a.jpg')); ?>" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="col-lg-4 col-md-6">
                                  <div class="single_banner">
                                      <a href="#">
                                          <img src="<?php echo e(('public/frontend/images/banner/b.jpg')); ?>" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="col-lg-4 col-md-6">
                                  <div class="single_banner banner_three">
                                      <a href="#">
                                          <img src="<?php echo e(('public/frontend/images/banner/c.jpg')); ?>" alt="">
                                      </a>
                                  </div>
                              </div>
                          </div>
                                              ...
                                              <div class="product__content text-center">
                                                <div class="produc_desc_info">
                                                      <div class="product_title">
                                                          <h4><a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$product->product_id)); ?>"><?php echo e($product->product_name); ?></a></h4>
                                                      </div>
                                                      <div class="product_price">
                                                          <p><?php echo e(number_format($product->product_price).' '.'đ'); ?></p><del>200,000₫</del>
                                                      </div>
                                                  </div>
                                                  <div class="product__hover">
                                                      <ul>
                                                          <li><a href="#"><i class="ion-android-cart" data-id_product="<?php echo e($product->product_id); ?>"></i></a></li>
                                                         
                                                          <li><a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$product->product_id)); ?>"><i class="ion-clipboard"></i></a></li>
                                                      </ul>
                                                  </div>
                                  ...
                                  <div class="shipping_list d-flex justify-content-between flex-xs-column">
                                      <div class="single_shipping_box d-flex">
                                          <div class="shipping_icon">
                                              <img src="<?php echo e(('public/frontend/images/ship/1.png')); ?>" alt="shipping icon">
                                          </div>
                                      ...
                                      <div class="single_shipping_box one d-flex">
                                          <div class="shipping_icon">
                                              <img src="<?php echo e(('public/frontend/images/ship/2.png')); ?>" alt="shipping icon">
                                          </div>
                                          <div class="shipping_content">
                                      ...
                                      <div class="single_shipping_box two d-flex">
                                          <div class="shipping_icon">
                                              <img src="<?php echo e(('public/frontend/images/ship/3.png')); ?>" alt="shipping icon">
                                          </div>
                                          <div class="shipping_content">
                                      ...
                                      <div class="single_shipping_box three d-flex">
                                          <div class="shipping_icon">
                                              <img src="<?php echo e(('public/frontend/images/ship/4.png')); ?>" alt="shipping icon">
                                          </div>
                                          <div class="shipping_content">
                                          ...
                                          <div class="single_product__inner">
                                              ...
                                              <div class="product__content text-center">
                                                  ...
                                                  <div class="produc_desc_info">
                                                      ...
                                                      <div class="product_price">
                                                          <p><?php echo e(number_format($product->product_price).' '.'đ'); ?></p>
                                                      </div>
                                                  </div>
                                                  <div class="product__hover">
                                                      <ul>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DACS2\resources\views/pages/home.blade.php ENDPATH**/ ?>