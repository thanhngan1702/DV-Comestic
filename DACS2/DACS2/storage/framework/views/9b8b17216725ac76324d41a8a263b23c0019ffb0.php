              ...
              <div class="menu">
                <nav>
                  <ul>
                    ...
                    <li class="active"><a href="<?php echo e(URL::to('/bo-suu-tap')); ?>">Bộ sưu tập</a></li>
                    <li class="active"><a href="<?php echo e(URL::to('/gioi-thieu')); ?>">Giới thiệu </a> </li>
                    <li class="active"><a href="<?php echo e(URL::to('/lien-he')); ?>">Liên hệ</a></li>
                  </ul>
                </nav>
              </div>
            </div>
