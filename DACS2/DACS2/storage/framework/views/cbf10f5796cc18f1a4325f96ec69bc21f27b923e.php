        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" href="<?php echo e(URL::to('/delete-brand-product/'.$brand_pro->brand_id)); ?>" class="active styling-edit" ui-toggle-class="">
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DACS2\resources\views/admin/all_brand_product.blade.php ENDPATH**/ ?>