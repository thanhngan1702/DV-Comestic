          ...
          <div class="product__content text-left">
            <div class="produc_desc_info">
              ...
              <div class="product_price price_shop">
                <p class="regular_price">250,000₫</p><p><?php echo e(number_format($product->product_price).' '.'đ'); ?></p>
              </div>
...
<?php echo $__env->make('pages.products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DACS2\resources\views/pages/category/show_category.blade.php ENDPATH**/ ?>