                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                      <div class="single__product">
                        <div class="single_product__inner"><span class="new_badge">new</span>
                          <div class="product_img"><a href="#"><img src="<?php echo e(URL::to('public/uploads/product/'.$product->product_image)); ?>" alt=""></a></div>
                          <div class="product__content text-center">
                            <div class="produc_desc_info">
                              <div class="product_title"><h4><a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$product->product_id)); ?>"><?php echo e($product->product_name); ?></a></h4></div>
                              <div class="product_price"><p><?php echo e(number_format($product->product_price).' '.'đ'); ?></p></div>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-5 col-sm-5">
                        <div class="single_product__inner inner_shop"><span class="new_badge">new</span><span class="discount_price">-5%</span>
                          <div class="product_img"><a href="#"><img src="<?php echo e(asset('public/fontend/images/product/sale/e.jpg')); ?>" alt=""></a></div>
                        </div> 
                      </div>
                      <div class="col-lg-8 col-md-7 col-sm-7">
                        <div class="product__content text-left">
                          <div class="produc_desc_info">
                            <div class="product_title title_shop"><h4><a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$product->product_id)); ?>">Cheese Butter Burger</a></h4></div>
...
<?php echo $__env->make('pages.products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DACS2\resources\views/pages/brand/show_brand.blade.php ENDPATH**/ ?>