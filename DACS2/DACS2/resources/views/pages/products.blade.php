        ...
        <div class="row">
            ...
            <div class="shop_sidebar">
              ...
              <div class="search_filters_wrapper">
                ...
                <div class="Compositions widget mb-30">
                  ...
                  <ul class="page_list_clearfix">
                    <li class="has-sub"><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->brand_id)}}">{{$brand->brand_name}}</a></li>
                  </ul>
                  @endforeach
                </div>
                </div>
          ...
          <div class="col-lg-9 col-md-12 col-12">
            ...
            <div class="categories_banner">
              <div class="categories_banner_inner"><img src="{{asset('public/frontend/images/banner/shop.jpg')}}" alt=""></div>
              <h3>SHOP</h3>
            </div>
            <!--banner shop end-->
            <!--menu giữa start-->
